  ...
  return (
    ...
    >
      ...
      <Container maxWidth="lg" sx={{ py: 8, bgcolor: '#20222f', position: 'relative', zIndex: 1 }}>
        ...
        {/* Original Menu Item Listing (can be removed if replaced by circular display) */}
        {/* You can keep this section or remove it if the circular display is sufficient */}
        {/* I'm commenting it out for now, assuming the circular display will be the primary presentation */}
